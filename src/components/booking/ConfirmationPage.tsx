              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-gray-600">{selectedFlight.number}</div>
                  </div>
                ...
                <div className="grid grid-cols-3 gap-4 py-4 bg-gray-50 rounded-lg px-4">
                  <div className="text-center">
                    ...
                    <div className="font-medium">{selectedFlight.departAt}</div>
                  </div>
                  <div className="text-center">
                  ...
                  <div className="text-center">
                    ...
                    <div className="font-medium">{selectedFlight.arriveAt}</div>
                  </div>
                </div>
