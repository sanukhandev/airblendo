      ...
      {flights.length ? (
        <ul className="space-y-4 mt-8">
          {flights.map((flight) => (
            <li
              key={flight.id}
              className="pointer bg-white border border-slate-200  rounded-lg shadow-md hover:shadow-lg transition-shadow"
            >
              <span className="bg-blue-900 text-white py-1 px-3 text-xs rounded-r-lg">
                Direct
              </span>
